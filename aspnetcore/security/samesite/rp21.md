...
En el código anterior, la autenticación de cookies y el estado de sesión establecen el atributo sameSite en `None` , emitiendo el atributo con un `None` valor y también establecen el atributo Secure en `true` .
