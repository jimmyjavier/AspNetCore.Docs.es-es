...
Para obtener más información sobre los esquemas de autenticación, vea [conceptos de autenticación](xref:security/authentication/index#authentication-concepts). Para obtener más información acerca de la autenticación de cookies, vea <xref:security/authentication/cookie> .
