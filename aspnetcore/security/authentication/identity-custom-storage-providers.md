...
ms.locfileid: "82775237"
---
# <a name="custom-storage-providers-for-aspnet-core-identity"></a>Proveedores de almacenamiento personalizados para ASP.NET CoreIdentity

Por [Steve Smith](https://ardalis.com/)

ASP.NET Core Identity es un sistema extensible que permite crear un proveedor de almacenamiento personalizado y conectarlo a la aplicación. En este tema se describe cómo crear un proveedor de almacenamiento personalizado Identitypara ASP.net Core. Trata los conceptos importantes para crear su propio proveedor de almacenamiento, pero no es un tutorial paso a paso.

[Vea o descargue el ejemplo de GitHub](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/security/authentication/identity/sample).
...
La capa de acceso a datos proporciona la lógica para guardar los datos Identity de ASP.net Core en un origen de datos. La capa de acceso a datos para el proveedor de almacenamiento personalizado podría incluir las siguientes clases para almacenar información de usuarios y roles.
...
* [ASP.net Core Identity ](https://github.com/dotnet/AspNetCore/tree/master/src/Identity) &ndash; este repositorio incluye vínculos a los proveedores de almacenes de la comunidad.
