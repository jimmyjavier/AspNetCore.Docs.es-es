---
title: "Configuración del modelo de hospedaje de ASP.NET Core Blazor" author: description: "Aprenda sobre la configuración del modelo de hospedaje de Blazor, incluida la integración de componentes de Razor en aplicaciones Razor Pages y MVC".
