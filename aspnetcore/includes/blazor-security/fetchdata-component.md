<span data-ttu-id="dd1ed-101">El `FetchData` componente muestra cómo:</span><span class="sxs-lookup"><span data-stu-id="dd1ed-101">The `FetchData` component shows how to:</span></span>
