<span data-ttu-id="77619-101">El `FetchData` componente muestra cómo:</span><span class="sxs-lookup"><span data-stu-id="77619-101">The `FetchData` component shows how to:</span></span>
