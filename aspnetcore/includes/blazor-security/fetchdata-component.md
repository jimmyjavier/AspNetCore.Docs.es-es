<span data-ttu-id="c1870-101">El `FetchData` componente muestra cómo:</span><span class="sxs-lookup"><span data-stu-id="c1870-101">The `FetchData` component shows how to:</span></span>
