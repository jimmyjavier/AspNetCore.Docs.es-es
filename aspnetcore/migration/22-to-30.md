...
En este artículo se explica cómo actualizar un proyecto existente de ASP.NET Core 2.2 a ASP.NET Core 3.0. Podría ser útil crear un nuevo proyecto ASP.NET Core 3.0 para:

* Compárese con el código ASP.NET Core 2.2.
* Copie los cambios relevantes en el proyecto ASP.NET Core 3.0.
