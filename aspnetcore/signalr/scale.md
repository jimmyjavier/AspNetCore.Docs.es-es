...
![Escalado SignalR sin un backplane](scale/_static/scale-no-backplane.png)
...
![Establecer una conexión con el servicio de Azure SignalR](scale/_static/azure-signalr-service-one-connection.png)
