...
Para agregar el registro de cliente .NET a una Blazor aplicación Webassembly, vea <xref:blazor/fundamentals/logging#blazor-webassembly-signalr-net-client-logging> .
